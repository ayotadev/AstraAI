...
export async function Navbar() {
  ...
  return (
    <header className="fixed top-10 left-5 right-5 px-6 py-4 bg-background/40 backdrop-blur-lg border border-white rounded-2xl shadow-xl z-50 md:max-w-5xl md:mx-auto">
